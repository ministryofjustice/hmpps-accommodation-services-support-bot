# Community Accommodation Services Support Bot
...
Select "Manage non working days" workflow
Click "Run workflow"
...
Use 'remove' to remove specific days/dates.
Use 'clear' to remove all days and dates.
...
[TODO - these tasks need to be addressed]
